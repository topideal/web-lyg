...
function getDataList() {
    ...
    $('#data_list').DataTable({
        ...
        "sAjaxSource": "/classified/getCountryListByPaginator.do",
        ...
        "aoColumnDefs": [
            {
                ...
                "mRender": function (data, type, full) {
                    return "<input type='checkbox' value='" + data.countryId + "' />";
                }
            },/*{
                "aTargets": [1],
                "mRender": function (data, type, full) {
