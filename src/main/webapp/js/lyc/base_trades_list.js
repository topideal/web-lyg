...
function getDataList() {
    ...
    $('#data_list').DataTable({
        ...
        "sAjaxSource": "/classified/getTradesListByPaginator.do",
        ...
        "aoColumnDefs": [
            {
                ...
                "mRender": function (data, type, full) {
                    return "<input type='checkbox' value='" + data.tradesId + "' />";
                }
            },/*{
                "aTargets": [1],
                "mRender": function (data, type, full) {
