$(function () {
    ...
    $.ajax({
        ...
        url: "/recruitCategory/getRecruitCategoryListForAll.do",
        async: false,
        success: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                opts += "<option value='" + data[i].id + "'>" + data[i].titleCn + "</option>";
            }
...
function getDataList() {
    ...
    $('#data_list').DataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "/cn/recruit/getRecruitListByPaginator.do",
...
function onEdit(obj) {
    ...
    $("#edueation").val(obj.edueation);
    $("#jobAddr").val(obj.jobAddr);
