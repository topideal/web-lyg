...
function getDataList() {
    ...
    $('#data_list').DataTable({
        ...
        "sAjaxSource": "/classified/getBrandsListByPaginator.do",
        ...
        "aoColumnDefs": [
            {
                ...
                "mRender": function (data, type, full) {
                    return "<input type='checkbox' value='" + data.brandsId + "' />";
                }
            },/*{
                "aTargets": [1],
                "mRender": function (data, type, full) {
