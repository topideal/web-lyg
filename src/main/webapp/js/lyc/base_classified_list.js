   ...
   // uploadBtn("uploadFileBtn","classifiedResName");
    ...
    $('#saveDataBtn').click(function () {
        ...
        $.ajax({
            ...
            url: "/classified/addClassified.do",
...
function getDataList() {
    ...
    $('#data_list').DataTable({
        ...
        "sAjaxSource": "/classified/getClassifiedListByPaginator.do",
        ...
        "aoColumnDefs": [
            {
                ...
                "mRender": function (data, type, full) {
                    return "<input type='checkbox' value='" + data.classifiedId + "' />";
                }
            },/*{
                "aTargets": [1],
                "mRender": function (data, type, full) {
...
function delMethod(data) {
    $.ajax({
        url: "/classified/delClassified.do",
        data: {delStr: data},
        type: 'POST',
        dataType: 'json',
        async: false,
