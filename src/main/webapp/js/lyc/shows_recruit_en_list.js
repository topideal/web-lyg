    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                opts += "<option value='" + data[i].id + "'>" + data[i].titleEn + "</option>";
            }
...
function getDataList() {
    ...
    $('#data_list').DataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "/en/recruit/getRecruitListByPaginator.do",
