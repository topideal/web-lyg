...
function getDataList() {
    ...
    $('#data_list').DataTable({
        ...
        "sAjaxSource": "/classified/getYearsListByPaginator.do",
        ...
        "aoColumnDefs": [
            {
                ...
                "mRender": function (data, type, full) {
                    return "<input type='checkbox' value='" + data.yearsCode + "' />";
                }
            },/*{
                "aTargets": [1],
                "mRender": function (data, type, full) {
            ...
            },*/
            {
                ...
                "mRender": function (data, type, full) {
                    ...
                    var btnStr = "<button class='btn btn-xs btn-default' onclick='onDel(" + JSON.stringify(data) + ")'><i class='icon-remove'></i> </button>";
