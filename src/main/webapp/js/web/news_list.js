        ...
        success: function (data) {
            if (data != null) {
                ...
                for (var i = 0; i < dataList.length; i++) {
                    ...
                    str += '<img onclick=\'visitNewsDetailUrl("' + dataList[i].infoId + '","' + dataList[i].infoTitleEn + '")\' src="' + resUrl + dataList[i].infoResName + '?imageView2/1/w/' + (Math.round(getScreenRatio() / 4) + 100) + '/h/' + Math.round(((getScreenRatio() / 4) + 100) * 0.55) + '/format/jpg/interlace/1" class="img-responsive">';
                    //  str += '</a>';
                    str += "</div>";
                    ...
                    str += '<div class="media-body"  onclick=\'visitNewsDetailUrl("' + dataList[i].infoId + '","' + dataList[i].infoTitleEn + '")\'>';
                  ...
                  //  str += '<p class="font_color_80 font_size_10 content_font" style="padding-top:12px;line-height: 1.1;">' + (typeof (dataList[i].classifiedTitleEn) == "object" ? '' : dataList[i].classifiedTitleEn.toLowerCase()) + '</p>';
                    ...
                    if (Cookies.get("A-" + dataList[i].infoId) == "1") {
                        ...
                        str += '<li onclick=\'javascript:setBrowser("' + dataList[i].infoId + '");this.className="info_visited";return;\' style="padding-top: 18px;border-bottom: 0px solid #262626;cursor:default">';
                    }
                    str += picUpSvg;
                    str += '</li>';
                ...
                if (searchType != null && searchType != '') {
                    url = "/" + searchType + "/" + searchKey + "/newslist.do";
                }
