...
$(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data != null) {
                ...
                contentStr += '<div class="title_font" style=\'background-image: url("/images/info_title_bg.jpg");color: #fff;padding: 0px 20px 0px 5px;font-size: 24px;\'>'+info[0].infoTitleEn+'</div>';
                ...
                contentStr += '<div class="col-xs-12 col-sm-12 col-md-12" >';
                contentStr += '<div class="content_txt_div">';
                contentStr += info[0].infoRemarkEn;
                contentStr += '</div>';
                contentStr += '</div>';
                contentStr += '</div>';
    ...
    $.ajax({
        url: "/info/getPrevNextNewsDetail.do",
        data: {infoId: $('#infoId').val()},
        type: 'POST',
        dataType: 'json',
        async: false,
        success: function (data) {
            if (data.code == 200) {
                ...
                if (prevInfo != null) {
                    $("#prevInfoTag").show();
                    var str = '<div class="media detail_thumbnail" style="cursor: pointer;" onclick=\'visitNewsDetailUrl("' + prevInfo.infoId + '","' + prevInfo.infoTitleEn + '")\'>';
                ...
                if (nextInfo != null) {
                    $("#nextInfoTag").show();
                    str = '<div class="media detail_thumbnail" style="cursor: pointer;" onclick=\'visitNewsDetailUrl("' + nextInfo.infoId + '","' + nextInfo.infoTitleEn + '")\'>';
