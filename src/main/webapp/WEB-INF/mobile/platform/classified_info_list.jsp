                    ...
                    <div class="col-md-12">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-head">
                                <div class="pull-left">作品展示列表</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">作品信息编辑</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" method="post" id="addFm" novalidate="novalidate">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select class="form-control" name="classifiedId" id="classifiedId" placeholder="类型">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="infoTitle" id="infoTitle" class="form-control" placeholder="内容">
                        </div>
                    </div>
                    <div class="form-group">
...
<%@ include file="js.jsp" %>
<script src="/js/lyc/classified_info_list.shows_info_list.js"></script>
