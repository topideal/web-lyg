...
<!-- Modal -->
<div id="addDataModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="addDataModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" id="addFm" novalidate="novalidate">
                    <input type="hidden" name="classifiedId" id="id"/>
                    <input type="hidden" name="classifiedResName" id="classifiedResName"/>

                    <div class="form-group">
                        <label class="col-lg-4 control-label">名称</label>
                        <div class="col-lg-8">
                            <input type="text" name="classifiedTitle" id="classifiedTitle" class="form-control" placeholder="类型名称">
                        </div>
                    </div>
                    <%--<div class="form-group">
                        <label class="col-md-4 control-label">备注</label>
                        <div class="col-md-8">
                            <textarea name="classifiedRemark" id="classifiedRemark" rows="5" class="form-control" placeholder="备注"></textarea>
                        </div>
                    </div>--%>
                    <div class="form-group">
...
<%@ include file="js.jsp" %>
<script src="/js/lyc/classified_list.base_classified_list.js"></script>
