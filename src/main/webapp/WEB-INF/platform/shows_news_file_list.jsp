                    ...
                    <div class="col-md-12">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-head">
                                <div class="pull-left">新闻图片展示</div>
                                <div class="widget-icons pull-right">
                                    <div class="btn-group">
                                        ...
                                        <a class="btn btn-large tip-bottom" title="返回新闻动态" href="/platform/url/shows_news_list.do"><i class="icon-backward"></i></a>
                                    </div>
...
<%@ include file="js.jsp" %>
<script src="/js/lyc/shows_news_file_list.js"></script>
