            ...
            <div class="modal-body">
                <form class="form-horizontal" method="post" id="addFm" novalidate="novalidate">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="yearsCode" id="yearsCode" class="form-control" placeholder="年度">
                        </div>
                    </div>
...
<%@ include file="js.jsp" %>
<script src="/js/lyc/base_years_list.js"></script>
