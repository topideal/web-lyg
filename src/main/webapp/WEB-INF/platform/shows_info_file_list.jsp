                            ...
                            <div class="widget-head">
                                ...
                                <div class="widget-icons pull-right">
                                    <div class="btn-group">
                                        ...
                                        <a class="btn btn-large tip-bottom" title="返回作品列表" href="/platform/url/shows_info_list.do"><i class="icon-backward"></i></a>
                                    </div>
...
<%@ include file="js.jsp" %>
<script src="/js/lyc/shows_info_file_list.js"></script>
